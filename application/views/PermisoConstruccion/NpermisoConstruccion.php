...
<?php $dataUser = $this->session->all_userdata(); ?>
            ...
            <div class="ibox-title" style="padding: 15px 15px 7px;  min-height: 66px;">
               ...
               <div class="col-xs-12">
                   <div class="col-xs-6 col-sm-6">
                       <h2 style=" color: #24544b; font-weight: bold;">Permisos de Construccion</h2>
                   </div>
                   <?php if($dataUser['PconstruccionA'] == "1"){ ?>
                   <div class="col-md-6">
                       <div class="col-md-12">
                        ...
                        <form action="pdfs/pdfPermisoConstruccion" method="POST">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    ?>
                                    <?php }else{ ?>
                                        <a href="RenovacionPermisoContruccion"><button type="button" class="btn btn-success">Caducado</button></a>
                                    <?php } ?>
                                </div>
                            </div>
                            </form>
...
<section id="AddpermisoFuncionamientoPersonaI" class="">
    <div class="col-md-12">
        <form action="permisos/add_permisoConstruccion" id="formPermisos" method="POST" enctype="multipart/form-data">
            
            <div class="col-md-12">
                <h3>Permiso de Construccion Para Personas(Inmuebles)</h3>
            </div>
                        ...
                        var dato = '<div class="permisoN'+i+'">';
                            ...
                            dato += '<div class="col-md-12">';
                                dato += '<div class="col-md-12 text-center">';
                                    dato += '<div class="col-md-4">Informe de inspección: </div>';
                                ...
                                dato += '<div class="col-md-12 text-center" style="border-top: 1px solid;margin-top: 10px;">';
                                    dato += '<div class="col-md-6">Copia del pago del Impuesto Predial del año en curso.</div>';
                                    dato += '<div class="col-md-6">Construcciones mayores incluir planos </div>';
                                dato += '</div>';
                                ...
                                dato += '<div class="col-md-12 text-center" style="border-top: 1px solid;margin-top: 10px;">';
                                    dato += '<div class="col-md-12">';
                                        dato += 'Plan de contingencia en caso de requerirlo. ';
                                    dato += '</div>';
                                dato += '</div>';
...
<section id="AddpermisoFuncionamientoEmpresaI" class="">
    <div class="col-md-12">
        <form action="permisos/add_permisoConstruccion" id="formPermisos" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-md-12">
                <h3>Permiso de Construccion Para Empresas(Inmuebles)</h3>
            </div>
